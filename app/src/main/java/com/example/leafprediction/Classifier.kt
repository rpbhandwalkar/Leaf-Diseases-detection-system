...
class Classifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    init {
        ...
        // tensorflow interpreter class to get input from the model with set of actions
        //using multi threading and flaoting point CPU kernal
        interpreter = Interpreter(loadModelFile(assetManager, modelPath), options)
        //loading labels from leaf_labels from asset lolder
    ...
    //sorting the results based on confidance of the array recived from interpreter
